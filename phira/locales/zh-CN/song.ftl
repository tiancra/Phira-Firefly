...
stabilize = 申请上架谱面
stabilize-warn = 普通用户每 3 天可以申请一次上架谱面。至少拥有一张上架谱面的用户每 1 天可以申请一次。
stabilize-requested = 申请上架谱面成功
stabilize-failed = 申请上架谱面失败
stabilize-approve = 通过 special
stabilize-approve-ranked = 通过上架谱面
stabilize-approve-confirm = 确定通过该谱面的评议吗？该操作无法撤销。
stabilize-comment =上架谱面留言
